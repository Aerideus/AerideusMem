/*
    ...
    Aerideus Log is a lightweight and easy to use library for memory tracking. For
    information about usage and features, please see documentation (README.md) at
    https://github.com/Aerideus/AerideusLog.
...
int main(void)
{
	...
	*a = 5;
	...
	// Checks for memory leaks before terminating and logs result to the console
